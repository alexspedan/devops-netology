...
```
alexsp@alexsp-aimc:~/netology/Ansible-Sandbox/playbook3$ ansible-galaxy install -r requirements.yml
- extracting java to /home/alexsp/.ansible/roles/java
- java (1.0.1) was installed successfully
```
3. Перейдите в каталог с ролью elastic-role и создайте сценарий тестирования по умолчаню при помощи `molecule init scenario --driver-name docker`.
```
alexsp@alexsp-aimc:~/netology/elastic-role$ molecule init scenario --driver-name docker
INFO     Initializing new scenario default...
INFO     Initialized scenario in /home/alexsp/netology/elastic-role/molecule/default successfully.
```
4. Добавьте несколькоколь разных дистрибутивов (centos:8, ubuntu:latest) для инстансов и протестируйте роль, исправьте найденные ошибки, если они есть.
